...
// llm-translator, magic translation 확장의 번역문(message.extra.display_text)과
 ...
 * 텍스트에 htmlMode 적용
 * 'keep'   - 원본 그대로
 * 'strip'  - HTML 태그 제거, innerText 보존 + {{img::...}} 제거
 * 'remove' - HTML 태그+내용 전체 제거 + {{img::...}} 제거
 */
